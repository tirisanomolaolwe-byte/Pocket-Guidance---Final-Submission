...
public final class CategoryDao_Impl implements CategoryDao {
  ...
  public CategoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCategoryEntity = new EntityInsertionAdapter<CategoryEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR IGNORE INTO `categories` (`id`,`userId`,`name`,`isCustom`) VALUES (nullif(?, 0),?,?,?)";
      }
    ...
    this.__preparedStmtOfDeleteByName = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "DELETE FROM categories WHERE userId = ? AND name = ? AND isCustom = 1";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object deleteByName(final long userId, final String name,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
  ...
  @Override
  public Flow<List<CategoryEntity>> getAllForUser(final long userId) {
    final String _sql = "SELECT * FROM categories WHERE userId = ? ORDER BY isCustom ASC, name ASC";
      ...
      public List<CategoryEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _tmpIsCustom = _tmp != 0;
            _item = new CategoryEntity(_tmpId,_tmpUserId,_tmpName,_tmpIsCustom);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object findByName(final long userId, final String name,
      ...
      public CategoryEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _tmp = _cursor.getInt(_cursorIndexOfIsCustom);
            _tmpIsCustom = _tmp != 0;
            _result = new CategoryEntity(_tmpId,_tmpUserId,_tmpName,_tmpIsCustom);
          } else {
            _result = null;
          }
          return _result;
